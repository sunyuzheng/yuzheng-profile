...
| Claim | What it establishes | Source |
|---|---|---|
...
These numbers are useful but volatile.
...
| 2023-03-18 | [《如何不被ChatGPT卷掉？｜脑艺人》](https://www.youtube.com/watch?v=mCpQ3XCt9JQ) | In a solo video, Yuzheng connected replacing repetitive work and changing exam-oriented education with more room for creation (01:39–03:27), then described having time to consider life's meaning, develop craft, and become a “脑艺人” (05:09–05:56). This is contemporaneous support for the human-development side of the later founder motivation; it does not establish that the 2023 essay used the flood or Renaissance metaphors verbatim. |
...
Public claim: Agentic AI was the most important near-term shift in AI, with a meaningful 10–18 month opportunity window.

**Source:** [Video](https://youtu.be/FzbkAy0DcQk)

### March 2025: MCP

Public claim: MCP had major structural flaws, and the hype exceeded what the protocol could reliably deliver.

**Source:** [Video](https://youtu.be/kwwjR6HHJPM)

### March 2026: OpenClaw

Public claim: OpenClaw would not last, even though trying it was useful for understanding the underlying capability shift.
...
| Shuchao Bi | Head of Post-Training, Multimodal, OpenAI | [Conversation](https://www.youtube.com/watch?v=7ej2r7XysKc) |
| Reynold Xin | Co-founder, Databricks | [Conversation](https://www.youtube.com/watch?v=GIv0I-34aaI) |
| Vijaye Raji | Founder, Statsig; CTO of Applications, OpenAI | [Conversation](https://www.youtube.com/watch?v=iw2QYZeVlOQ) |
...
| Learner | Role | What the feedback demonstrates |
|---|---|---|
| Julia | Strategy Ops Manager, TikTok | Non-engineers can learn to think in systems and apply AI to work and daily life. |
| Chairy | UX Manager, Google | Daily AI users still find deeper theory-to-practice value. |
| Shuyang | Senior Applied Science Manager, Uber | The course builds a learning model rather than teaching only temporary tricks. |
| Yue | Senior Software Engineer, Amazon | Technical practitioners found the capstone and practical work substantive. |
| Max Xiao | Senior Principal TPM, Oracle | The user-to-builder approach supports durable independent learning. |
| Christine | Quantitative Researcher, JPMorgan Chase | AI building practices transfer beyond conventional software roles. |

One additional outcome is useful when the boundary is stated precisely: Marvin, a developer at Yipi Tech, wrote in a Maven review that a tool he built with the builder mindset earned back roughly twice the cohort fee. The public review verifies the two-times outcome. The note that he left the review roughly two months after his cohort is an inference from cohort and review dates, not wording from the review itself.
...
Founder, Statsig; CTO of Applications, OpenAI
