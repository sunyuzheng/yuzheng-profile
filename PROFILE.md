...
Yuzheng's public conversations and analysis can be compressed into one recurring question: `真正把事做成的人，到底做对了什么？` The reader-facing promise is `把他们做对的，变成你做得到的。` The first line gives interviews, essays, and analysis a single memorable editorial question. The second names the desired transformation: turn the underlying judgment and craft behind someone else's result into capability that can help make work of one's own. On short surfaces the pair may appear without the complete philosophy or subject list; deeper surfaces should show the actual people, decisions, methods, and work that make the transfer credible.

## The Narrative

### 1. Learn to ask what actually causes an outcome

Economics was not merely an academic credential. At Cornell, it trained Yuzheng to look beneath visible correlations: incentives, constraints, counterfactuals, and the causal structure behind a decision. That habit became the base layer of his later work in data, growth, product, and AI.

The recurring question was never just, "What does the data say?" It was, "What would have to be true for this result to change what we do next?"
...
- **Theory and operating responsibility:** economics and causal reasoning, followed by product, management, and founder work.
- **Individual contributor and organizational leader:** hands-on analysis as well as leadership of a 30-person data and AI team.
- **China and the United States:** long exposure to both technology ecosystems and their different operating assumptions.
...
See [EVIDENCE.md](EVIDENCE.md) for dates, wording boundaries, and source links.
